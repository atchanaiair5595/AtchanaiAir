...
// ========================================================
// 🔢 2. ระบบแบ่งหน้า + เสกปุ่มแชร์อัตโนมัติสไตล์ WordPress
// ========================================================
const ITEMS_PER_PAGE = 4; // กำหนดให้แสดงผลหน้าละ 4 บทความเท่านั้นเพื่อความเร็วสูงสุด
let currentPage = 1;
...
function initPaginationAndSharing() {
    ...
    // 🌟 4. ระบบอ่านลิงก์เป้าหมายและทำไฮไลท์เมื่อเปิดผ่านลิงก์แชร์ 🌟
    const urlParams = new URLSearchParams(window.location.search);
    const postQuery = urlParams.get('post'); // ดักจับ ?post= จากโซเชียลมีเดีย
    const hash = window.location.hash; // ดักจับ # จากการก๊อปปี้ลิงก์
    
    // จัดลำดับความสำคัญ ถ้ามี ?post= ให้ใช้ค่านี้ก่อน
